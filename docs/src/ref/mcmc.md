...
- If you find yourself copying the same continuous source address to multiple locations, it probably means your involution is not valid. (The Jacobian matrix will have rows that are identical, and so the Jacobian determinant will be zero).
