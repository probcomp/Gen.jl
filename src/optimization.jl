"""
    state = init(conf, gen_fn::GenerativeFunction, param_list::Vector)
...
This is syntactic sugar for the constructor form above.
...
"""
    conf = ADAM(learning_rate, beta1, beta2)
